...
Security is a priority. We maintain a proactive stance to identify and fix vulnerabilities in **spv-wallet**.

<br/>

## 🛠️ Supported & Maintained Versions
Any released version of **spv-wallet** that is not marked as deprecated is actively supported and maintained.
