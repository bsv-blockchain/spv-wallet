...
Need help with **spv-wallet**? You're in the right place. Here’s how to get support, report issues, and stay aligned with project guidelines.
...
* 🔍 Search [Issues](https://github.com/bsv-blockchain/spv-wallet/issues) or [Pull Requests](https://github.com/bsv-blockchain/spv-wallet/pulls?q=is%3Apr+is%3Aopen+is%3Aclosed)
* 🆕 Can’t find what you need? Start a [new issue](https://github.com/bsv-blockchain/spv-wallet/issues/new?template=question.yml).
...
1. Check the [issue tracker](https://github.com/bsv-blockchain/spv-wallet/issues) to avoid duplicates.
